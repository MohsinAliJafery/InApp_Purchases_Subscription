...
public class SpecialProductAdapter extends RecyclerView.Adapter<SpecialProductAdapter.MyViewHolder>{
...
public SpecialProductAdapter(AppCompatActivity appCompatActivity, List<SkuDetails> skuDetailsList, BillingClient billingClient) {
...
public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        .inflate(R.layout.layout_special_product_display_for_adapter, parent, false));
